...
- **Megamenus**: `aweai allc` prints **10,000+ commands & instructions**; `aweai autoallc` prints **5,000+ automations**.
- **In-app terminal**: `aweai terminal` launches a full REPL with every CLI tool available.
- **Browser UI**: `aweai serve` → http://localhost:8888 with menus, training, terminal, marketplace.
...
- [[Build Instructions]] — APK / EXE / Linux / macOS / AppImage / web builds
...
All prebuilt artifacts are attached to [GitHub Releases](https://github.com/ARARAT33/AWEAI/releases): Android APK, Windows EXE, Linux binary, macOS app, AppImage, web static.
